            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 8, padding: 16 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12 }}>
                {[
                  ...
                  { l: 'MACD', v: technicals.macd, c: technicals.macd === 'Bullish' ? 'var(--green)' : 'var(--red)' },
                  { l: 'EMA 200', v: technicals.ema200, c: technicals.ema200 === 'Above' ? 'var(--green)' : 'var(--red)' },
                  { l: 'Bollinger', v: technicals.bollingerBands, c: 'var(--text-mid)' },
                  { l: 'Overall', v: technicals.signal, c: technicals.signal === 'Bullish' ? 'var(--green)' : 'var(--red)' },
                ].map(m => (
                  <div key={m.l} style={{ background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 6, padding: '10px 12px' }}>
                    ...
                    <div style={{ fontFamily: 'var(--mono)', fontSize: 13, fontWeight: 600, color: m.c }}>{m.v}</div>
                  </div>
                ))}
              </div>
            </div>
